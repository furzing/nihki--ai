...
const FloatingTranslateWord = () => {
  ...
  return (
    <div className="fixed top-6 right-6 z-50 w-32 h-20">
      <div 
        className={`
      ...
      >
        <div className="relative w-full h-full">
          ...
          {/* Main word bubble */}
          <div className="bg-white/90 backdrop-blur-sm border-2 border-black/20 rounded-2xl px-4 py-3 shadow-lg w-full h-full flex flex-col justify-center">
