...
export const translations = {
  en: {
    ...
    demo: {
      ...
      elapsed: "47 minutes elapsed",
      ceoName: "Sarah Chen - CEO",
      speakingIn: "Speaking in English",
      aiProcessing: "AI PROCESSING",
      toSpanish: "→ Spanish (Carlos)",
      toFrench: "→ French (Marie)",
      toEnglish: "→ English (Sarah)",
      responseTime: "Response Time",
      accuracy: "Accuracy Rate",
      languages: "Languages",
      sarahQuote: "Let's dive into our Q2 expansion strategy. I believe the European market presents our biggest opportunity, especially given the regulatory changes we've been tracking...",
      carlosQuote: "I completely agree, Sarah. However, we should also consider the specific cultural differences of each European region...",
      carlosName: "Carlos Rodriguez",
      speakingInSpanish: "Speaking in Spanish",
  ...
  ar: {
    ...
    demo: {
      ...
      toFrench: "→ الفرنسية (ماري)",
      toEnglish: "→ الإنجليزية (سارة)",
      responseTime: "وقت الاستجابة",
      accuracy: "معدل الدقة",
      languages: "اللغات",
      sarahQuote: "دعونا نتعمق في استراتيجية التوسع للربع الثاني. أعتقد أن السوق الأوروبية تمثل أكبر فرصة لدينا، خاصة بالنظر إلى التغييرات التنظيمية التي كنا نتتبعها...",
